class_name GodotParadisePlatformerMovement extends GodotParadiseMotion
...
func accelerate_horizontally(direction: Vector2, delta: float =  get_physics_process_delta_time()) -> GodotParadisePlatformerMovement:
...
func decelerate_horizontally(delta: float = get_physics_process_delta_time(), force_stop: bool = false) -> GodotParadisePlatformerMovement:
...
func accelerate_vertically(direction: Vector2, delta: float =  get_physics_process_delta_time()) -> GodotParadisePlatformerMovement:
	facing_direction = _normalize_vector(direction)
...
func decelerate_vertically(delta: float = get_physics_process_delta_time(), force_stop: bool = false) -> GodotParadisePlatformerMovement:
...
func apply_gravity(delta: float = get_physics_process_delta_time()) -> GodotParadisePlatformerMovement:
	if gravity_enabled:
...
func invert_gravity() -> GodotParadisePlatformerMovement:
...
func suspend_gravity_for_duration(duration: float) -> GodotParadisePlatformerMovement:
	if duration > 0:
...
func change_gravity_temporary(gravity: float, time: float) -> GodotParadisePlatformerMovement:
...
func jump(height: float = jump_height, bypass: bool = false) -> GodotParadisePlatformerMovement:
...
func wall_slide(delta: float =  get_physics_process_delta_time()) -> GodotParadisePlatformerMovement:
	if can_wall_slide():
...
func wall_climb(direction: Vector2) -> GodotParadisePlatformerMovement:
	if can_wall_climb():
...
func reset_jump_queue() -> GodotParadisePlatformerMovement:
